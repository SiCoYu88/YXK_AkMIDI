...
#ifndef AudioBusHackerFXParams_H
#define AudioBusHackerFXParams_H
...
struct AudioBusHackerRTPCParams
{
    AkReal32 fPlaceholder;
};

struct AudioBusHackerNonRTPCParams
{
};

struct AudioBusHackerFXParams
    : public AK::IAkPluginParam
{
    AudioBusHackerFXParams();
    AudioBusHackerFXParams(const AudioBusHackerFXParams& in_rParams);
    ...
    AudioBusHackerRTPCParams RTPC;
    AudioBusHackerNonRTPCParams NonRTPC;
};

#endif // AudioBusHackerFXParams_H
