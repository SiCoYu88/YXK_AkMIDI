...
AudioBusHackerPlugin::AudioBusHackerPlugin()
{
}
...
bool AudioBusHackerPlugin::GetBankParameters(const GUID & in_guidPlatform, AK::Wwise::Plugin::DataWriter& in_dataWriter) const
{
...
DEFINE_AUDIOPLUGIN_CONTAINER(AudioBusHacker);											// Create a PluginContainer structure that contains the info for our plugin
EXPORT_AUDIOPLUGIN_CONTAINER(AudioBusHacker);											// This is a DLL, we want to have a standardized name
ADD_AUDIOPLUGIN_CLASS_TO_CONTAINER(                                             // Add our CLI class to the PluginContainer
    ...
    AudioBusHackerPlugin,  // Authoring plug-in class to add to the plug-in container
