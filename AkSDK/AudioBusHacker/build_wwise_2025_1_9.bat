...
if not defined WWISEROOT set "WWISEROOT=H:\Audiokinetic\Wwise_2025.1.9.9197"
...
:preflight
echo ============================================================
echo AudioBusHacker - Wwise 2025.1.9.9197
...
:package
echo.
echo ===== Create 2025.1.9 packages and bundle =====
...
call :check_file "%PROJECT_ROOT%AudioBusHacker_v2025.1.9_Build9197_SDK.Windows_vc170.tar.xz"
call :check_file "%PROJECT_ROOT%AudioBusHacker_v2025.1.9_Build9197_Authoring.Windows_x64.Debug.tar.xz"
call :check_file "%PROJECT_ROOT%AudioBusHacker_v2025.1.9_Build9197_Authoring.Windows_x64.Release.tar.xz"
...
call %PYTHON_LAUNCHER% -c "import json; b=json.load(open(r'%PROJECT_ROOT%bundle.json', encoding='utf-8')); v=b['version']; raise SystemExit(0 if (v['year'],v['major'],v['minor'],v['build']) == (2025,1,9,9197) and len(b['files']) == 3 else 1)"
if errorlevel 1 (
...
echo   WWISEROOT        Default: H:\Audiokinetic\Wwise_2025.1.9.9197
