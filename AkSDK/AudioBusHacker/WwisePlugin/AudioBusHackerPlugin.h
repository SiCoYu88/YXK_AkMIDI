...
class AudioBusHackerPlugin final
    : public AK::Wwise::Plugin::AudioPlugin
{
public:
    AudioBusHackerPlugin();
    ~AudioBusHackerPlugin();
...
DECLARE_AUDIOPLUGIN_CONTAINER(AudioBusHacker);	// Exposes our PluginContainer structure that contains the info for our plugin
