...
#ifndef AudioBusHackerConfig_H
#define AudioBusHackerConfig_H
...
namespace AudioBusHackerConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 15450;
}

#endif // AudioBusHackerConfig_H
