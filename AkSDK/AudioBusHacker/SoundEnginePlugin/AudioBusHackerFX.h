...
//    );
//
//AK_EXTERNAPIFUNC(void, SetAudioBusHackerCallbacks)(
...
//void SetAudioBusHackerCallbacks(AkAudioBusHackerPluginExecuteCallbackFunc in_ABHExecCallback);
