...
bool FAkAudioDevice::EnsureInitialized()
{
	...
	{
		SCOPED_AKAUDIO_EVENT_4(TEXT("FAkAudioDevice::EnsureInitialized ProfileConnect"));
	...
	{
		SCOPED_AKAUDIO_EVENT_4(TEXT("FAkAudioDevice::EnsureInitialized ProfilerDisconnect"));
